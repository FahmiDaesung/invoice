           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
            ...
            <?php
             if(isset($_GET['aksi']) == 'hapus'){
				$id = $_GET['id'];
				$cek = mysqli_query($koneksi, "SELECT * FROM bank WHERE id_bank='$id'");
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM bank WHERE id_bank='$id'");
					if($delete){
			...
			?>
<a href="input_bank.php" class="btn btn-sm btn-warning"><i class="fa fa-file"></i> Tambah data</a> <br /><br />
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['nomer_rk'];?></center></td>
                    <td><center><?php echo $data['jenis'];?></center></td>
                    <td><center><?php echo $data['nama_pemilik'];?></center></td>
                    <td><center><?php echo $data['nama_agency'];?></center></td>
                    


                        <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data Admin" href="edit_bank.php?aksi=edit&id_bank=<?php echo $data['id_bank'];?>"><span class="glyphicon glyphicon-edit"></span></a>  

                         <a onclick="return confirm ('Yakin hapus <?php echo $data['nomer_rk'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data bank" href="bank.php?aksi=hapus&id=<?php echo $data['id_bank'];?>"><span class="glyphicon glyphicon-trash"></a></center>
