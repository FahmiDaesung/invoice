           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
            ...
            <?php
             if(isset($_GET['aksi']) == 'hapus'){
				$id = $_GET['id'];
				$cek = mysqli_query($koneksi, "SELECT * FROM agency WHERE id_agency='$id'");
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM agency WHERE id_agency='$id'");
					if($delete){
			...
			?>
<a href="input_agency.php" class="btn btn-sm btn-warning"><i class="fa fa-file"></i> Tambah data</a> <br /><br />
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>nama agency</center></th>
                        <th><center>nama website </center></th>
                    ...
                    <td><center><?php echo $data['nama_agency'];?></center></td>
                    <td><center><?php echo $data['nama_website'];?></center></td>
                    ...
                    <td><center><?php echo $data['email'];?></center></td>
                      ...
                      <td><center><img src="<?php echo $data['gambar'] ?>" class="img-rounded" height="100" width="150" style="border: 2px solid #666666;" /></td>
                        ...
                        <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data agency" href="edit_agency.php?aksi=edit&id_agency=<?php echo $data['id_agency'];?>"><span class="glyphicon glyphicon-edit"></span></a>  

                         <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_agency'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data admin" href="agency.php?aksi=hapus&id=<?php echo $data['id_agency'];?>"><span class="glyphicon glyphicon-trash"></a></center>
