...
<?php include "waktu.php"; ?>
      ...
      $sql = mysqli_query($koneksi, "SELECT * FROM admin WHERE id_user='$id_user'");
  ...
  {     
    ...
    if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
      $sql="UPDATE admin SET nama='$nama', alamat='$alamat', username='$username', password='$password', level='$level', gambar='$gambar' , jenis_kelamin='$jenis_kelamin' , usia='$usia' WHERE id_user='$id_user'";
                ...
                <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="usia" type="text" id="usia" class="form-control" value="<?php echo $row['usia']; ?>"  placeholder="Password" autocomplete="off" required />
